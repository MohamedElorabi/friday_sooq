                                ...
                                <div class="check-text">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="featured-corner">
                                            <img src="<?php echo e(asset('wb/imgs/icons/featured-corner.svg')); ?>"
                                                alt="featured-corner">
                                            <h5>الركن المميز</h5>
                                        </label>
                                    </div>
                                ...
                                <div class="check-text">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="update-your-ad">
                                            <img src="<?php echo e(asset('wb/imgs/icons/update.svg')); ?>" alt="update-your-ad">
                                ...
                                <div class="check-text">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="install-in-farwaniya">
                                            <img src="<?php echo e(asset('wb/imgs/icons/pin.svg')); ?>" alt="install-in-farwaniya') }}">
                                            <h5>
                                ...
                                <div class="check-text">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="install-in-buy-furniture">
                                            <img src="<?php echo e(asset('wb/imgs/icons/pin.svg')); ?>" alt="install-in-buy-furniture">
                                            <h5>
                                                ثبت إعلانك في نشتري الأثاث
                                            </h5>
                                        </label>
                                ...
                                <div class="check-text">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="highlight">
                                            <img src="<?php echo e(asset('wb/imgs/icons/highlight.svg')); ?>" alt="highlight">
                                            <h5>
                                ...
                                <div class="check-text">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="wait-install-furniture">
                                            <img src="<?php echo e(asset('wb/imgs/icons/pin-1.svg')); ?>"
                                ...
                                <div class="check-text">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="shop-ad-buy-furniture">
                                            <img src="<?php echo e(asset('wb/imgs/icons/pin-1.svg')); ?>" alt="shop-ad-buy-furniture">
                                            <h5>
...
<?php echo $__env->make('site.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/frdaysq/public_html/resources/views/site/ads/upgrade-ad.blade.php ENDPATH**/ ?>