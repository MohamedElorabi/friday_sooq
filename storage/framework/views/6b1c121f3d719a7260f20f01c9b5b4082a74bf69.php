...
<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('wb/css/star-rating-svg.css')); ?>">
<?php $__env->stopPush(); ?>
        ...
        <div class="shop-header">
            <div class="container">
                <div class="shop-cover">
                    <img src="<?php echo e($store->cover); ?>" alt="cover">
                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="shop-img-name">
                                <div class="image">
                                    <?php if($store->getAvailableAttribute()): ?>
                                        <div class="active"></div>
                                    <?php endif; ?>
                                    <div class="shop-image">
                                        <img src="<?php echo e($store->avatar); ?>" alt="image">
                                    </div>
                                </div>
                                <div class="text">
                                    <h4 class="name"><?php echo e($store->name); ?></h4>
                                    <p class="type"><?php echo e($store->type_name); ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="row">
                                    ...
                                    <div class="info">
                                        <ul>
                                            <li>
                                                ...
                                                <p>انضم <?php echo e($store->created_at); ?></p>
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <p><?php echo e($store->views); ?> مشاهدة</p>
                                            </li>
                                            <li>
                                ...
                                <div class="col-sm-6">
                                    <div class="likes-follows">
                                        <p class="likes"><?php echo e(count($store->likes)); ?><span>معجب</span></p>
                                        <p class="follows"><?php echo e(count($store->followers)); ?><span>متابع</span></p>
                                    </div>
                                    <div class="buttons">
                                        ...
                                        <a href="#" data-href="<?php echo e(route('change.follow.unfollow', $store->user_id)); ?>"
                                    ...
                                    <div class="social-links">
                                        <ul>
                                            <li>
                                                <a href="<?php echo e($store->youtube); ?>" target="_blank"><i
                                                        class="fab fa-youtube"></i></a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e($store->snapchat); ?>" target="_blank"><i
                                                        class="fab fa-snapchat-ghost"></i></a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e($store->instagram); ?>" target="_blank"><i
                                                        class="fab fa-instagram"></i></a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e($store->twitter); ?>" target="_blank"><i
                                                        class="fab fa-twitter"></i></a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e($store->facebook); ?>" target="_blank"><i
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fields fade show active" id="pills-fields" role="tabpanel"
                        ...
                        <ul>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $store_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <li>
                                    <a href="<?php echo e(route('show-category-products', $store_category->id)); ?>">

                                        <img src="<?php echo e($store_category->image); ?>" alt="">
                                        <p><?php echo e($store_category->store_category_name); ?></p>
                    ...
                    <div class="tab-pane ads fade" id="pills-ads" role="tabpanel" aria-labelledby="pills-ads-tab">
                        <div class="row">
                            <?php $__empty_1 = true; $__currentLoopData = $flyers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="col-lg-4 col-6 mb-4">
                                    <div class="shop-field-card shadow-sm">
                                        <button class="favourite-btn">
                                            <i class="fal fa-heart"></i>
                                        </button>
                                        <a href="<?php echo e(route('product.details', $store->id)); ?>"
                                            class="image image-cover customSmHeight">
                                            <img src="<?php echo e($item->image); ?>" alt="ad">
                                        </a>
                                        <div class="card-body">
                                            <div class="text">
                                                <h6 class="name text-truncate"><?php echo e($item->name); ?></h6>
                                                <h5 class="price"><?php echo e($item->price); ?>د.ك</h5>
                                            </div>
                                            <button class="add-to-cart"><a
                                                    href="<?php echo e(route('add.to.cart', $item->id)); ?>"></a><i
                    ...
                    <div class="tab-pane rating fade" id="pills-rating" role="tabpanel"
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <form action="<?php echo e(route('store.rate')); ?>" id="rateFrm" method="post">
                                    <?php echo csrf_field(); ?>
                                    <div class="user-rate">
                                        <div class="title">
                                            <h5>التقييم</h5>
                                    ...
                                    <div class="title">
                                        ...
                                        <p>متوسط التقييم`
                                            <span class="rates-val"><i class="fas fa-star"></i>
                                                5.0</span>
                                            <span class="votes-number"><?php echo e(count($store->rate)); ?></span>
                                            صوت
                                        </p>
                                    </div>
                                    <div class="bars">
                    ...
                    <ul>
                        ...
                        <li>
                            <a id="copyNumber" data-bs-toggle="popover" data-bs-placement="top"
                                ...
                                aria-valuenow="<?php echo e($store->phone); ?>">
                                <div class="row">
                                    <div class="col-2 d-flex align-items-center justify-content-start">
                        ...
                        <li>
                            <a href="https://wa.me/<?php echo e($store->phone); ?>" target="_blank">
                                <div class="row">
                                    <div class="col-2 d-flex align-items-center justify-content-start">
...
<?php $__env->startPush('custom-scripts'); ?>
    <script src="<?php echo e(asset('wb/js/jquery.star-rating-svg.min.js')); ?>"></script>
    <script>
        // like-ad-and-unlike
        ...
        function followStore() {
            ...
            $.ajax({
                ...
                if (data) {
                    console.log(data)
                    $('.follow').empty();
                    $('.follow').append("<i class='fal fa-user-times'></i><?php echo e(__('site.Un_follow')); ?>")
                    // 
                } else {
                    $('.follow').empty();
                    $('.follow').append("<i class='fal fa-user-plus'></i><?php echo e(__('site.Follow')); ?>")
                }
            });
        }
...
<?php echo $__env->make('site.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/frdaysq/public_html/resources/views/site/stores/show.blade.php ENDPATH**/ ?>