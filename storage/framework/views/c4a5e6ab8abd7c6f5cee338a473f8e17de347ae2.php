...
<?php $__env->startSection('content'); ?>
    <section class="upgrade-to-shop">
        ...
        <?php endif; ?>
        <div class="container">
            <form action="<?php echo e(route('site.stores.store')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="cover" id="storeCover">
                    ...
                    <img src="<?php echo e(asset('wb/imgs/store-img.svg')); ?>" class="default-cover" alt="store-cover">
                </div>
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="img sameHeight" id="storeImg">
                                ...
                                <img src="<?php echo e(asset('wb/imgs/store-img.svg')); ?>" alt="store-img" class="default-img">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-9">
...
<?php echo $__env->make('site.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/frdaysq/public_html/resources/views/site/stores/upgrade_store.blade.php ENDPATH**/ ?>