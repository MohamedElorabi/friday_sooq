                ...
                <div class="col-lg-6 m-auto">
                    <div class="white-card h-100">
                        ...
                        <div class="icon sameHeight">
                            <img src="<?php echo e(asset('wb/imgs/icons/points-trans.svg')); ?>" alt="points-trans">
                        </div>
                        <div class="total-points">
                            <h5 class="title">
                                مجموع النقاط:
                            </h5>
                            <h5 class="num"><?php echo e(auth()->user()->points); ?></h5>
                        </div>
...
<?php echo $__env->make('site.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/frdaysq/public_html/resources/views/site/loyalty_program/send_points.blade.php ENDPATH**/ ?>