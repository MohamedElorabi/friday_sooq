                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action={{route('users.update',$info->id)}} method="post" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    {{method_field('PUT')}}
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" value="{{$info->mobile}}" id="name_en" type="text"  name="mobile">
                                    </div>
                                    <div class="mb-3">
                                        <label class="col-form-label pt-0" for="name_ur">البريد الالكتروني </label>
                                        <input class="form-control" value="{{$info->email}}" id="name_ur" type="text"  name="email">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="select"  name="country_id"  class="form-control">
                                            ...
                                            @foreach($countries as $country)
                                                <option value="{{$country->id}}" {{($country->id ==$info->country_id)? "selected":""}}>{{$country->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="mb-3">
