            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">اضافه  دوله جديده</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                <form action={{route('countries.store')}} method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="name_en" type="text"  name="code">
                                    </div>
                                    <div class="mb-3">
                                        <label class="col-form-label pt-0" for="name_en">العمله</label>
                                        <input class="form-control" id="name_en" type="text"  name="currency">
                                    </div>
                                    <div class="mb-3">
                                        <label class="col-form-label pt-0" for="name_en">Iso</label>
                                        <input class="form-control" id="name_en" type="text"  name="iso">
                                    </div>
