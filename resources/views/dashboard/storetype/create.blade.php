            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">اضافه  نوع لمتجر جديد</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action={{route('storetypes.store')}} method="post" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label class="col-form-label pt-0" for="name_en"> الصوره</label>
