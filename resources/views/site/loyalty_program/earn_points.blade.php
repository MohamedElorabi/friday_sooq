    ...
    <section class="loyalty-program-page earn-points link-details">
        <div class="container">
            <div class="current-level">
                <img src="{{ asset('wb/imgs/member-layer.svg') }}" alt="current-level" class="level-img">
                <div class="text">
            ...
            <div class="levels-progress">
                <div class="levels">
                    <div class="level">
                        <div class="image">
                            <img src="{{ asset('wb/imgs/bronze.svg') }}" alt="bronze">
                        </div>
                        <h6 class="name">برونزى</h6>
                    </div>
                    <div class="level">
                        <div class="image">
                            <img src="{{ asset('wb/imgs/silver.svg') }}" alt="silver">
                        </div>
                        <h6 class="name">فضى</h6>
                    </div>
                    <div class="level">
                        <div class="image">
                            <img src="{{ asset('wb/imgs/golden.svg') }}" alt="golden">
                        </div>
                        <h6 class="name">ذهبى</h6>
                    </div>
                    <div class="level">
                        <div class="image">
                            <img src="{{ asset('wb/imgs/platinium.svg') }}" alt="platinium">
                        </div>
