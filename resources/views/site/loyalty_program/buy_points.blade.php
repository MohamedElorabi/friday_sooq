                ...
                <div class="col-lg-6 m-lg-auto m-0">
                    <div class="white-card h-100">
                        <div class="icon sameHeight">
                            <img src="{{ asset('wb/imgs/icons/buy-points.svg') }}" alt="buy-points">
                        </div>
                        ...
                        <form action="">
                            <div class="form-group mb-4">
                                ...
                                <div class="row">
                                    @foreach ($point_packages as $point)
                                        <div class="col-sm-4 mb-sm-0 mb-3 d-flex align-items-center">
                                            <div class="points-radio">
                                                <input type="radio" class="btn-check" name="points"
                                                    value="{{ $point->points }}" id="{{ $point->id }}" autocomplete="off"
                                                    required>
                                                <label class="points-label shadow-sm" for="{{ $point->id }}">
