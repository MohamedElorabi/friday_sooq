        ...
        <div class="container">
            <div class="white-card">
                ...
                <div class="points-progress gold">
                    <img src="{{ asset('wb/imgs/member-layer.svg') }}" class="layer-img" alt="layer">
                    <div class="progress-details">
                        <div class="layer-name-points">
                            <h6 class="name">ذهبية</h6>
                            <h6 class="points">{{ auth()->user()->points }} نقطة</h6>
                        </div>
                        <div class="progress">
            ...
            <div class="links">
                <div class="row">
                    <div class="col-sm-3 col-6">
                        <a href="{{ route('send.points') }}" class="link shadow-sm">
                            <img src="{{ asset('wb/imgs/icons/points-trans.svg') }}" class="icon" alt="points-trans">
                            <h6 class="title">حول نقاط</h6>
                        </a>
                    </div>
                    <div class="col-sm-3 col-6">
                        <a href="{{ route('earn.points') }}" class="link shadow-sm">
                            <img src="{{ asset('wb/imgs/icons/points-earning.svg') }}" class="icon" alt="points-earning">
                            <h6 class="title">أكسب نقاط</h6>
                        </a>
                    </div>
                    <div class="col-sm-3 col-6">
                        <a href="{{ route('buy.points') }}" class="link shadow-sm">
                            <img src="{{ asset('wb/imgs/icons/buy-points.svg') }}" class="icon" alt="buy-points">
                            <h6 class="title">إشتر نقاط</h6>
                        </a>
                    </div>
                    <div class="col-sm-3 col-6">
                        <a href="{{ route('replace.points') }}" class="link shadow-sm">
                            <img src="{{ asset('wb/imgs/icons/redeem-points.svg') }}" class="icon" alt="redeem-points">
                            <h6 class="title">استبدال النقاط</h6>
                        </a>
                    </div>
                    <div class="col-sm-3 col-6">
                        <a href="membership-card.html" class="link shadow-sm">
                            <img src="{{ asset('wb/imgs/icons/membership-card.svg') }}" class="icon"
                                alt="membership-card">
                    ...
                    <div class="col-sm-3 col-6">
                        <a href="donate.html" class="link shadow-sm">
                            <img src="{{ asset('wb/imgs/icons/donate.svg') }}" class="icon" alt="donate">
                            <h6 class="title">تبرع</h6>
                        </a>
                    </div>
                    <div class="col-sm-3 col-6">
                        <a href="shopping.html" class="link shadow-sm">
                            <img src="{{ asset('wb/imgs/icons/shopping.svg') }}" class="icon" alt="shopping">
                    ...
                    <div class="col-sm-3 col-6">
                        <a href="become-partner.html" class="link shadow-sm">
                            <img src="{{ asset('wb/imgs/icons/become-partner.svg') }}" class="icon" alt="become-partner">
