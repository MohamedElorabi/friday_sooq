                    ...
                    <div class="col-lg-6 col-md-9 m-auto">
                        <div class="white-card">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control input-1" name="name" id="product-name"
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea class="form-control input-1" name="product-describtion" id="product-describtion" name="desc"
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select class="form-select input-1" id="category" name="store_category_id"
                                    aria-label="Default select example">
                                    <option selected disabled>اختر قسم المنتج</option>
                                    @foreach ($store_categories as $store_category)
                                        <option value="$store_category->id">{{ $store_category->title }}</option>
                                    @endforeach


                                </select>
                                @if ($errors->has('store_category_id'))
                                    <span class="text-danger text-left">{{ $errors->first('store_category_id') }}</span>
                                @endif
                            </div>
                                ...
                                <ul class="colors-checks" dir="ltr">
                                    <li>
                                        <input type="radio" class="btn-check" name="color" id="red"
                                            value="red" autocomplete="off" required>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="number" min="0" value="0"
                                            class="form-control input-1 text-center" name="quantity" id="stock-num"
                                            required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
